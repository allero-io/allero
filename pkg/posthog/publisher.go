...
func (pc *PosthogClient) postEvent(client posthog.Client, command string, args map[string]interface{}) error {
	...
	for key, value := range args {
		// TODO - to keep Posthog convention replace key from format "ThisIsMyKeyName" to "This Is My Key Name" https://pkg.go.dev/github.com/mitchellh/mapstructure#section-readme
